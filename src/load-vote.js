const voteList = require('@malereg/aowatch-client/entities/entity.vote').voteList;
...
module.exports =  async function loadVote() {
    // create a new progress bar instance and use shades_classic theme
    const bar1 = new cliProgress.SingleBar({
        format: 'Vote |' + '{bar}' + '| {percentage}% || {value}/{total} Chunks',
    ...
    const res = listAll(voteList, 4, politicianEmitter);
    return res.then((res)=>{
        bar1.stop();
        return res;
    });
