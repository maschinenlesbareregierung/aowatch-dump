const pollList = require('@malereg/aowatch-client/entities/entity.poll').pollList;
...
module.exports =  async function loadPoll() {
    // create a new progress bar instance and use shades_classic theme
    const bar1 = new cliProgress.SingleBar({
        format: 'Poll |' + '{bar}' + '| {percentage}% || {value}/{total} Chunks',
    ...
    const res = listAll(pollList, 4, politicianEmitter);
    return res.then((res)=>{
        bar1.stop();
        return res;
    });
