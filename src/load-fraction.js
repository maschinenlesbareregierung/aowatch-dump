const fractionList = require('@malereg/aowatch-client/entities/entity.fraction').fractionList;
...
module.exports =  async function loadFraction() {
    // create a new progress bar instance and use shades_classic theme
    const bar1 = new cliProgress.SingleBar({
        format: 'Fraction |' + '{bar}' + '| {percentage}% || {value}/{total} Chunks',
    ...
    const res = listAll(fractionList, 4, politicianEmitter);
    return res.then((res)=>{
        bar1.stop();
        return res;
    });
