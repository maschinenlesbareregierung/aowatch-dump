const sidejobOrganizationList = require('@malereg/aowatch-client/entities/entity.sidejob-organization').sidejobOrganizationList;
...
module.exports =  async function loadSidejob() {
    ...
    const bar1 = new cliProgress.SingleBar({
        format: 'Sidejob Organization |' + '{bar}' + '| {percentage}% || {value}/{total} Chunks',
    ...
    const res = listAll(sidejobOrganizationList, 4, politicianEmitter);
    return res.then((res)=>{
        bar1.stop();
        return res;
    });
