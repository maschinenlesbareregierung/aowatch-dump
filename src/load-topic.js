const topicList = require('@malereg/aowatch-client/entities/entity.topic').topicList;
...
module.exports =  async function loadTopic() {
    // create a new progress bar instance and use shades_classic theme
    const bar1 = new cliProgress.SingleBar({
        format: 'Topic |' + '{bar}' + '| {percentage}% || {value}/{total} Chunks',
    ...
    const res = listAll(topicList, 4, politicianEmitter);
    return res.then((res)=>{
        bar1.stop();
        return res;
    });
